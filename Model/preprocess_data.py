...
import re
import os
from Model.question_classification import Question_classify
...
class Question():
    ...
    def init_config(self):
        ...
        # 读取问题模板
        with(open(filePath+"/data/question/question_classification.txt","r",encoding="utf-8")) as f:
    ...
    def question_posseg(self):
        jieba.load_userdict(filePath+"/data/userdict.txt")
...
if __name__ == "__main__":
    que = Question()
    print(que.question_process("唐山市在2001年的地区生产总值指数是？"))